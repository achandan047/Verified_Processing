...
args = {
    ...
    'task_name': 'both',
    'output_dir': 'outputs_information/',
    'cache_dir': 'cache/',
    'do_train': False,
    'do_eval': False,
    'do_predict': True,
...
if args['do_predict']:
    ...
    # pdb.set_trace()
    import pandas as pd
    df = pd.read_csv('processed_data/unlabeled_phase3.csv')
    df['Information_binary'] = binary_preds
    df.to_csv('processed_data/unlabeled_phase3_labeled.csv')